...
<template>
<div v-if="data.type === 'perDay' || data.type === 'perMonth' || data.type === 'perYear'" class="lg:w-2/3 mt-4 w-full mx-auto overflow-auto">
...
<div v-if="data.type === 'decile'" class="lg:w-2/3 mt-4 w-full mx-auto overflow-auto">
    <table class="table-auto w-full text-left whitespace-no-wrap">
        <thead>
        <tr>
...
<div v-if="data.type === 'rfm'" class="lg:w-2/3 mt-4 w-full mx-auto overflow-auto">
    <h2 class="text-center text-2x1">RFM分析結果</h2>
